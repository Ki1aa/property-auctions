  ...
  app/
    ...
    services/
      ...
      alerts/
        ...
        telegram.py    # send_telegram_message (parse_mode, preview)
  alembic/
    env.py
...
**Не сделано / на паузе:**
- НСПД: клиент и запись в `lots.nspd_*` при ingest при `NSPD_ENABLED` (сеть к `nspd.gov.ru`). Циан/Авито/Домклик как источники аналогов - не подключены.
